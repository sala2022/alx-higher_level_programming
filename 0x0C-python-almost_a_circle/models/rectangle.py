...
class Rectangle(Base):
    ...
    def update(self, *args, **kwargs):
        """updatess attributes of rectongle """
        if args:
            i = 0
    ...
    def area(self):
        """returns the area of rectongle"""
        return self.width * self.height

    def display(self):
        """printts in stdout the Rectangle instance with the character #"""
        print('\n' * self.y, end="")
